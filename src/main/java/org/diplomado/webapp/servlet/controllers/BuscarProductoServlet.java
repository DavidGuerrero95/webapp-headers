package org.diplomado.webapp.servlet.controllers;
...
import org.diplomado.webapp.servlet.models.Producto;
import org.diplomado.webapp.servlet.services.ProductoService;
import org.diplomado.webapp.servlet.services.ProductoServiceImpl;
...
public class BuscarProductoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (encontrado.isPresent()){
            ...
            resp.sendError(HttpServletResponse.SC_NOT_FOUND, "Lo sentimo no esta autorizado para ingresar a esta pagina!");
    }
}
